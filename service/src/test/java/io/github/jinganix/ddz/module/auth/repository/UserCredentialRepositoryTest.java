...
class UserCredentialRepositoryTest {
  ...
  class Meta extends SpringIntegrationTests {
    ...
    @Autowired UserCredentialRepository.Meta meta;
    ...
    class Module {
      ...
      class WhenCalled {
        ...
        void thenReturn() {
          assertThat(meta.module()).isEqualTo("model_user_credential");
        }
      }
    }
    ...
    class IndexId {
      ...
      class WhenCalled {
        ...
        @DisplayName("then return")
        void thenReturn() {
          assertThat(meta.indexId(new UserCredential("name", "pwd", UID_1))).isEqualTo("name");
        }
      }
    }
  }
